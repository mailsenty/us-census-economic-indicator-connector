...
public class BeforeMessageProcessorDebuggable
    extends BeforeMessageProcessor
    implements DebugInfoProvider
{


    public BeforeMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("beforeyear", "Beforeyear", (java.lang.String.class), beforeyear, muleEvent));
