...
public class BetweenMessageProcessorDebuggable
    extends BetweenMessageProcessor
    implements DebugInfoProvider
{


    public BetweenMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("from", "From", (java.lang.String.class), from, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("to", "To", (java.lang.String.class), to, muleEvent));
