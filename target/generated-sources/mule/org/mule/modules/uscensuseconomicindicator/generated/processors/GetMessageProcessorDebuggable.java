...
public class GetMessageProcessorDebuggable
    extends GetMessageProcessor
    implements DebugInfoProvider
{


    public GetMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("year", "Year", (java.lang.String.class), year, muleEvent));
