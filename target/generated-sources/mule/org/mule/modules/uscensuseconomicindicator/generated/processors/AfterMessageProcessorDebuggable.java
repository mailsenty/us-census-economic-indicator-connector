...
public class AfterMessageProcessorDebuggable
    extends AfterMessageProcessor
    implements DebugInfoProvider
{


    public AfterMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("fromyear", "Fromyear", (java.lang.String.class), fromyear, muleEvent));
